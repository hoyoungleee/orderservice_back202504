...
import com.playdata.orderservice.user.dto.UserSaveDto;
...
public class UserController {
     ...
     */
    @PostMapping("/create")
    public ResponseEntity<?> userCreate(@RequestBody @Valid  UserSaveDto dto) {
    ...
    @PostMapping("/doLogin")
    public ResponseEntity<?> doLogin(@RequestBody @Valid UserLoginReqDto dto){
